...
export default function Home() {
  ...
  async function createQuote(event: FormEvent) {
    event.preventDefault();
    const response = await fetch("/api/quotes", { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify(quoteForm) });
